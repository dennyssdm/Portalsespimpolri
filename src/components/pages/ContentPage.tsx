...
export function ContentPage({ content, path }: ContentPageProps) {
  ...
  return (
    <main>
      ...
      {path !== '/profil/struktur-organisasi' && path !== '/profil/fasilitas' && path !== '/profil/pejabat' && path !== '/sarana-prasarana/klinik-pratama' && !path.startsWith('/kelembagaan-internal') && !path.startsWith('/widyaiswara') && (
