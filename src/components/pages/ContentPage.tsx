...
export function ContentPage({ content, path }: ContentPageProps) {
  ...
  return (
    <main>
      ...
      >
        {(path === '/sarana-prasarana/elibrary' || path === '/sarana-prasarana/ejurnal') && content.externalLink && (
          <div className="mt-8">
            <a
          ...
          <div className={cn(
            ...
            {!isEditorialBoardPage && (
              <aside className="space-y-5">
                ...
                {content.externalLink && path !== '/sarana-prasarana/elibrary' && path !== '/sarana-prasarana/ejurnal' ? (
