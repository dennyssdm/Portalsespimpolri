...
export function ContentPage({ content, path }: ContentPageProps) {
  ...
  const discoverySections = (
    <>
      {featurePanel && path !== '/profil/kontak/susunan-redaksi' && path !== '/profil/kontak/contact' ? <PageFeaturePanel panel={featurePanel} /> : null}
  ...
  return (
    <main>
      ...
      {path !== '/profil/struktur-organisasi' && path !== '/profil/fasilitas' && path !== '/profil/pejabat' && path !== '/sarana-prasarana/klinik-pratama' && !path.startsWith('/kelembagaan-internal') && !path.startsWith('/widyaiswara') && !path.includes('kontak') && !path.includes('contact') && !path.includes('redaksi') && (
