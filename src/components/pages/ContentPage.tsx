...
export function ContentPage({ content, path }: ContentPageProps) {
  ...
  return (
    <main>
      ...
      >
        {(path === '/sarana-prasarana/elibrary' || path === '/sarana-prasarana/ejurnal' || path === '/sarana-prasarana/lms-siapsespim') && content.externalLink && (
          <div className="mt-8">
            <a
      ...
      {path !== '/profil/struktur-organisasi' && path !== '/profil/fasilitas' && path !== '/profil/pejabat' && path !== '/profil' && path !== '/sarana-prasarana/klinik-pratama' && path !== '/sarana-prasarana/ejurnal' && !path.startsWith('/kelembagaan-internal') && !path.startsWith('/widyaiswara') && !path.startsWith('/program-pendidikan') && !path.includes('kontak') && !path.includes('contact') && !path.includes('redaksi') && (
          ...
          <div className={cn(
            ...
            {!isEditorialBoardPage && (
              <aside className="space-y-5">
                ...
                {content.externalLink && path !== '/sarana-prasarana/elibrary' && path !== '/sarana-prasarana/ejurnal' && path !== '/sarana-prasarana/lms-siapsespim' ? (
