...
export default async function Page() {
  const path = "/berita/kegiatan/portal-berita"
  ...
  let dbContent = null
  try {
    const res = await serverFetch('/api/berita-informasi-content/n-3', { cache: 'no-store' })
    if (res.ok) {
    ...
    console.warn('Failed to fetch dynamic content for /berita/kegiatan/portal-berita:', err)
  }
