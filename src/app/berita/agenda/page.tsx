...
export default async function Page() {
  ...
  let dbContent = null
  try {
    const res = await serverFetch('/api/berita-informasi-content/n-5', { cache: 'no-store' })
    if (res.ok) {
    ...
    console.warn('Failed to fetch dynamic content for /berita/agenda:', err)
  }
