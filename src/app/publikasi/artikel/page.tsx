...
export default async function Page() {
  const categoryName = "Artikel"
  const path = "/publikasi/artikel"
  const eyebrow = "Publikasi"
  const title = "Artikel & Opini"
  const description = "Kumpulan artikel ilmiah dan opini kepemimpinan yang ditulis oleh Widyaiswara, pakar, dan praktisi Sespim Lemdiklat Polri."
