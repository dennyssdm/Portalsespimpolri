...
export default async function Page() {
  ...
  try {
    const res = await serverFetch('/api/publikasi-content/pub-jurnal-ilmiah', { cache: 'no-store' })
    if (res.ok) {
    ...
    console.warn("Failed to fetch Jurnal Ilmiah from API, using fallback:", err)
  }
